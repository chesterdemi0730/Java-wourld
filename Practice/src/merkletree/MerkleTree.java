...
public class MerkleTree {
	...
	/**
	 * Initialises an empty Merkle Tree using the specified digest algorithm.
	 * 
	 * @param md
	 *            The message digest algorithm to be used by the tree
	 */
	...
	/**
	 * @return The digest associate with the root node of this Merkle Tree
	 */
	public byte[] digest() {
		return (digest);
	}
	...
	/**
	 * Returns a string representation of the specified byte array, with the values
	 * represented in hex. The values are comma separated and enclosed within square
	 * brackets.
	 * 
	 * @param array
	 *            The byte array
	...
	/**
	 * Private version of prettyPrint in which the number of spaces to indent the
	 * tree are specified
	 * 
	 * @param indent
	...
	private void prettyPrint(final int indent) {
		...
		if (rightLeaf != null && leftLeaf != null) {
			...
			System.out.println("Left leaf: " + rightLeaf.toString() + " Right leaf: " + leftLeaf.toString());
